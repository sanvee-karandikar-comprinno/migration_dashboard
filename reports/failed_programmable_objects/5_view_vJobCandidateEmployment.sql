-- ERROR:
(psycopg2.errors.SyntaxError) syntax error at or near "APPLY"
LINE 26: CROSS APPLY jc."Resume".nodes(N'declare default element name...
               ^

[SQL: CREATE VIEW "HumanResources"."vJobCandidateEmployment"
AS
SELECT
    jc."JobCandidateID"
